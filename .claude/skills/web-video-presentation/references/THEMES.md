...
> 本仓库另含 **`luji-trail`（路迹）** —— 与出门玩儿 / luji-app 品牌色
> 对齐，推荐搭配 **9:16 竖屏**做微信视频号。
...
| `luji-trail`         | **路迹 / 出门玩儿品牌** —— 暖纸 `#faf9f7` + 炭灰墨 `#1a1c1e` + 森林绿 `#2e7d32`。Inter + Noto Sans SC。**48px 淡暖网格 + 20px 软阴影卡片**。产品演示 / 出行 / **视频号竖屏**首选。calm product pace（520/820ms）。 |
